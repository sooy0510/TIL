...
# 정보를 던져줄 페이지
def throw(request):
  return render(request, 'sooy/throw.html')
...
def result(request):
  ...
  return render(request, 'sooy/result.html', context)


# 회원가입 폼을 보여주는 페이지
def user_new(request):
  return render(request, 'sooy/user_new.html')
...
def user_create(request):
  ...
  return render(request, 'sooy/user_create.html', context)


def static_sample(request):
  return render(request, 'sooy/static_sample.html')