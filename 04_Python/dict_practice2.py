...
"""
print('==== Q3 ====')
class_president = t4ir['classes']['connected']["class president"]
print(f'connected반의 방장은 {class_president} 입니다')
...
web
"""
for item in t4ir['language'].keys():
  print(item)
...
매니저
"""
for item in t4ir['classes']['bigdata'].values():
  print(item)
...
오늘의 당번은 황민승
"""
lucky = random.choice(t4ir['classes']['connected']['groups']['E'])
print(f'오늘의 당번은 {lucky} 입니다')